import { abilityMap, EntityState, CalculationTypes } from "../types";
...
let AbilitiesDB: abilityMap = {
    base_attack: {
        ...
        targetPropertyAffected: [{ key: "health", type: CalculationTypes.REMOVE, min: 1, max: 2 }],
        requiredToLearn: [],
    },
    ...
    heal: {
        ...
        affinity: "wisdom",
        casterPropertyAffected: [{ key: "mana", type: CalculationTypes.REMOVE, min: 10, max: 10 }],
        targetPropertyAffected: [{ key: "health", type: CalculationTypes.ADD, min: 10, max: 20 }],
        requiredToLearn: [
            { key: "level", amount: 5 },
            { key: "intelligence", amount: 25 },
